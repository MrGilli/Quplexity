...
extern "C" {
    void _gills_inv_matrix2x2(double* num1, double* num2, double* num3, double* num4, double* out_matrix);
    void _gills_matrix2x2(double matrixA[2][2], double matrixB[2][2], double matrixC[2][2]);
    void _gills_matrix2x1(double matrixA[2], double matrixB[2], double matrixC[1]);
    void _gills_hadamard2x1(double target_matrix2x1[2], double output[2]);
}
...
int main() {
    ...
    _gills_matrix2x2(matrixA, matrixB, matrixC);
    ...
    _gills_hadamard2x1(A.data(), Cx2x1.data());
    std::cout << "[" << Cx2x1[0] << "]" << "\n" << "[" << Cx2x1[1] << "]" << "\n";
